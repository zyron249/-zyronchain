...
- `mining.html` — protocol-v5 mining documentation; public downloads stay fail-closed. Default `npm run devnet` is not a mining network; the honest local path is `npm run mine:local`.
