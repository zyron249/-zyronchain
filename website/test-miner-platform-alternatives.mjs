...
if (!html.includes('npm run mine:local')) throw new Error('mining page must document the honest local v5 rehearsal');
if (!html.includes('protocol v1')) throw new Error('mining page must warn that default devnet stays protocol v1');
if (html.includes('http://127.0.0.1:9137')) throw new Error('mining page must not present 9137 as the local-devnet RPC');
