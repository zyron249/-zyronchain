...
The direct-entrypoint regressions intentionally exercise oversized genesis/checkpoint inputs and wrong-digest-before-parse ordering so this defense-in-depth boundary cannot silently drift back to raw unbounded reads.
