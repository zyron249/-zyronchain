...
| Z | Zero-downtime resilience | Partial gate | certified view-change, 4-validator/120-block repeated-proposer-failure convergence, 2/2 partition safety with 3/1 recovery/catch-up, future clock-skew rejection, backward-clock validator fail-stop, corrupt-store fail-stop and signal-driven graceful node drain/restart regressions are implemented; sustained real-network soak, mixed-version rolling-upgrade rehearsal and disaster-recovery drill remain |
