...
- root security disclosure plus maintainer/release succession policy remain present, require at least two genuinely independent custodians before public testnet, and forbid a unique founder recovery/admin authority;
