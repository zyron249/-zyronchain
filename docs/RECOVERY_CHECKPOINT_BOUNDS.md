...
- Linux/general CI and the Windows bounded-state workflow exercise this recovery-file boundary; those regressions are implementation evidence only, not target-hardware recovery-capacity evidence.
