...
When `Content-Length` is present it must use canonical decimal syntax, remain within the 64 KiB limit, and match the observed body length exactly. Oversized or mismatched responses fail closed.
